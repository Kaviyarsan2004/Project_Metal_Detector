...
-- Date        : Mon Apr 15 22:12:50 2024
-- Host        : LAPTOP-F28O89LN running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/EECE387_1/Lab_8_v2/Lab_8_v2/Lab_8_v2.srcs/sources_1/bd/mb_lab1/ip/mb_lab1_sensor_sonic_0_1/mb_lab1_sensor_sonic_0_1_sim_netlist.vhdl
-- Design      : mb_lab1_sensor_sonic_0_1
...
entity mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0_S00_AXI : entity is "sensor_sonic_v1_0_S00_AXI";
end mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0_S00_AXI;

architecture STRUCTURE of mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0_S00_AXI is
  ...
  signal \echo_sync_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \echo_sync_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \echo_sync_reg_reg_n_0_[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \echo_sync_reg[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \echo_sync_reg[1]_i_1\ : label is "soft_lutpair2";
begin
...
echo_sync_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => p_1_in,
...
\echo_sync_reg[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => ECHO,
      I1 => s00_axi_aresetn,
      I2 => \echo_sync_reg_reg_n_0_[0]\,
      O => \echo_sync_reg[0]_i_1_n_0\
    );
\echo_sync_reg[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => \echo_sync_reg_reg_n_0_[0]\,
      I1 => s00_axi_aresetn,
      I2 => p_1_in,
      O => \echo_sync_reg[1]_i_1_n_0\
    );
\echo_sync_reg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \echo_sync_reg[0]_i_1_n_0\,
      Q => \echo_sync_reg_reg_n_0_[0]\,
      R => '0'
    );
\echo_sync_reg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \echo_sync_reg[1]_i_1_n_0\,
      Q => p_1_in,
      R => '0'
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0 : entity is "sensor_sonic_v1_0";
end mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0;

architecture STRUCTURE of mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0 is
begin
sensor_sonic_v1_0_S00_AXI_inst: entity work.mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0_S00_AXI
     port map (
      ECHO => ECHO,
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_lab1_sensor_sonic_0_1 is
  port (
    ECHO : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of mb_lab1_sensor_sonic_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mb_lab1_sensor_sonic_0_1 : entity is "mb_lab1_sensor_sonic_0_1,sensor_sonic_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of mb_lab1_sensor_sonic_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of mb_lab1_sensor_sonic_0_1 : entity is "sensor_sonic_v1_0,Vivado 2023.1";
end mb_lab1_sensor_sonic_0_1;

architecture STRUCTURE of mb_lab1_sensor_sonic_0_1 is
...
U0: entity work.mb_lab1_sensor_sonic_0_1_sensor_sonic_v1_0
     port map (
      ECHO => ECHO,
