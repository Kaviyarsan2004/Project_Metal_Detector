...
HD_PWD='U:/EECE387/ip_repo/edit_Pmod_encod_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_encod_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_encod_v1_0.tcl
