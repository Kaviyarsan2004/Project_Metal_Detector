proc create_ipi_design { offsetfile design_name } {
	...
	set test_port_0 [ create_bd_cell -type ip -vlnv binghamton.edu:user:test_port:1.1 test_port_0]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/test_port_v1_1_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef test_port_v1_1_tb_include_vh_"
	puts $fp "`define test_port_v1_1_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores binghamton.edu:user:test_port:1.1]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/test_port_v1_1_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "test_port_v1_1_bfm_${i}"
...
remove_files -quiet -fileset sim_1 test_port_v1_1_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top test_port_v1_1_tb [get_filesets sim_1]
