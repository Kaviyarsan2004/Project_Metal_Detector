...
void sev_disp(uint8_t data[4])
{
	...
	const uint8_t disp_lut[16] = {0b00111111, 0b0000110, 0b01011011, 0b01001111,
...
int main()
{
    ...
    while(1)
    {
		...
		{
			if(maxVolt > Max_smallMetal + 400 ) //		medium metal size
			{
				if(maxVolt > Max_mediumMetal + 450 ) //		Large metal Size
				{
					large=1;
				}
				else
